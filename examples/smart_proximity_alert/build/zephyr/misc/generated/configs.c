...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEGGER_RTT_BUFFER_SIZE_UP, 8192);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEGGER_RTT_MODE_BLOCK_IF_FIFO_FULL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEGGER_RTT_MODE, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_DECAWAVE_DWM3001CDK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_DECAWAVE_DWM3001CDK_NRF52833, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_NRF52833_QDAA, 1);
